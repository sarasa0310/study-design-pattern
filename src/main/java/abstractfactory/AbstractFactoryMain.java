...
public class AbstractFactoryMain {
    public static void main(String[] args) {
        if (args.length != 2) {
            System.out.println("Usage: java AbstractFactoryMain filename.html class.name.of.Concrete Factory");
            System.out.println("Example 1: java AbstractFactoryMain list.html listfactory.ListFactory");
            System.out.println("Example 2: java AbstractFactoryMain div.html divfactory.DivFactory");
            System.exit(0);
        }
        ...
        // Page
        Page page = factory.createPage("Blog and News", "jimmy");
        page.add(blogTray);
        page.add(newsTray);
